    ...
    return ( 
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                <h1 className='fs-2 text-muted fs-3'>To create a ticket, select a relevant topic</h1>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className=''><i class="fa fa-envelope-o" aria-hidden="true"></i> Funds</h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className=''><i class="fa fa-stop-circle-o" aria-hidden="true"></i> Console</h4>
