    ...
    <div className="container border-top mt-5">
      <div className="row mt-5">
        ...
        <div className="col">
          ...
          <br></br>
          <a href="" style={{textDecoration:"none"}}>Zerodha cares (CRS)</a>
          <br></br>
          <a href="" style={{textDecoration:"none"}}>About</a>
          <br></br>
        </div>
        ...
        <div className="col">
          ...
          <br></br>
          <a href="" style={{textDecoration:"none"}}>60 day challeng</a>
          <br></br>
        </div>
      </div>
      <div className="mt-5 text-muted" style={{fontSize:"14px"}}> 
      <p>
        erodha Broking Ltd.: Member of NSE, BSE​ &​ MCX – SEBI Registration no.:
